...
def open_calculator(main_windo):
    ...
    currency_converter_frame = CTkFrame(currency_converter_tab, height=567 , width=500)
    currency_converter_frame.pack()

    windo = CTkFrame(currency_converter_frame, fg_color="black", height=567, width=500)
    windo.pack()
