...
class MultiUtilityApp:
    ...
    def change_mode(self, m):
        if m == "dark":
            self.mode_change_btn.configure(text="D",
                                           text_color="white",
                                           fg_color="black",
                                           hover_color="gray")
            ...
            self.copyright_frame.configure(fg_color="#cfcfcf", bg_color="#cfcfcf")
            ...
            self.U_copyright_frame.configure(fg_color="#cfcfcf", bg_color="#cfcfcf")

            self.mode = "light"

        elif m == "light":
            self.mode_change_btn.configure(text="L",
                                           text_color="black",
                                           fg_color="white",
                                           hover_color="gray")
            set_appearance_mode("dark")
            ...
            self.copyright_frame.configure(fg_color="#333333", bg_color="#333333")
            ...
            self.U_copyright_frame.configure(fg_color="#333333", bg_color="#333333")
    ...
    def open_calculator(self):
        ...
        self.mode_change_btn=CTkButton(self.main_cal_windo,
                                  text="L",
                                  text_color="black",
                                  fg_color="white",
                                  hover_color="gray",
                                  command=lambda:change_mode(self.mode),
                                  width=30,
                                  height=30,
                                  font=self.font_16)
        # self.mode_change_btn.place(x=468,y=10)
